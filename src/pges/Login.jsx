    ...
    >
      ...
      >
        ...
        <div className="col-md-6 col-12 p-0 d-flex flex-column justify-content-center">
          ...
          >
            {/* Header */}
            <div className="d-flex align-items-center justify-content-center w-100 position-relative pt-3 pb-2">
              <button
            ...
            <div className="d-md-none w-100 min-vh-100 d-flex flex-column justify-content-center align-items-center text-center px-4 overflow-hidden">
              ...
              {/* Welcome Text */}
              <h1 className=" textColor mt-3 mb-1 animate__animated animate__fadeInLeft">
                Welcome to Print<span className="text-warning fw-bold ">X</span>
              </h1>

              <p className="text-muted small mb-3 px-2">
                Sign in to your PrintX account to stay connected, manage print
                orders, and access all your printing services easily
              </p>
