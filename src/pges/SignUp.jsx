          ...
          >
            ...
            <div className="d-md-none d-flex align-items-center justify-content-center w-100 position-relative pt-3 pb-2">
              ...
              <h5 className="textColor fw-bold m-0 ">
                Sign Up <i className="fa-solid fa-user-lock ms-2"></i>
              </h5>
            </div>
            <div className="d-md-none w-100 min-vh-100 d-flex flex-column justify-content-center align-items-center text-center px-4 overflow-hidden">
              ...
              />
              {/* Welcome Text */}
              <h1 className=" textColor mt-4 mb-2 animate__animated animate__fadeInLeft">
                Welcome to Print<span className="text-warning fw-bold ">X</span>
              </h1>
              <p className="text-muted">
                Let’s get started! Create your account to enjoy seamless online
                printing.
              </p>
              {/* SignUp Form */}
              <form
